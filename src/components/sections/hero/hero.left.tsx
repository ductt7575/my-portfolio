...
const HeroLeft = (props: IProps) => {
    ...
    const handleDownloadCV = () => {
        openInNewTab("https://drive.google.com/file/d/1HtVyocJ34SK7x9IYCTAK7alLALdvl1FV/view?usp=sharing");
    };
    return (
        <div className="hero-left">
            ...
            <h3 style={{ paddingTop: 10, paddingBottom: 5 }}>
                I'M&nbsp;
                <strong className="brand-red">{t("appHeader.brand").toUpperCase()}</strong>
            </h3>
            <Typewriter
                options={{
                    strings: ["Front-End Developer", "Freelancer", "Software Developer", "Open Source Contributor"],
                    autoStart: true,
                    loop: true,
                    deleteSpeed: 50,
